...
ALTER TABLE match_queue
  ADD CONSTRAINT IF NOT EXISTS uq_match_player UNIQUE (match_id, player_id);

-- C) Wallet transaction audit (optional but highly recommended)
...
-- D) Safe wallet increment (already added before; keep for credit actions)
