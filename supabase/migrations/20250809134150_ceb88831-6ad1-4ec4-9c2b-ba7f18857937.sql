-- ============================================
-- PUOSU MARKET ENGINE: FULL INSTALL (SAFE) - CORRECTED
-- ============================================
...
-- wallet transactions (using existing schema)
-- The existing wallet_transactions table uses 'amount' not 'amount_cents'
-- So we'll work with that or create our own market-specific table
...
-- ---------- WALLET CREDIT RPC (using market-specific table) ----------
