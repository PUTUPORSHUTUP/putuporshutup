-- Auto-Scaling Player Pool Function
...
-- Trigger to auto-scale when player pool gets low
CREATE OR REPLACE TRIGGER trigger_auto_scale_players
...
-- Database maintenance function for weekly vacuuming
