-- Soft Launch Infrastructure - Core Functions Only
...
BEGIN
  ...
  -- 3. Process refunds (simplified - just credit back to profiles)
  WITH participant_refunds AS (
    UPDATE profiles 
    SET wallet_balance = wallet_balance + (
      SELECT SUM(cp.stake_paid)
  ...
  SELECT COUNT(*) INTO affected_users FROM participant_refunds;
